...
public class GuiCreateCustomWorld extends GuiCreateWorld {
     ...
     * We need to replace the version in CreateWorldGui if we are hiding the override
     */
    @Override
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
    	...
    	try{
	        ...
	        {
	        	this.drawString(this.fontRendererObj, I18n.format("selectWorld.mapFeatures.info", new Object[0]), this.width / 2 - 75, 122, -6250336);
	        }
	    	...
	    	((GuiTextField)guiReflectHelper.field_146335_h.get(this)).drawTextBox();
